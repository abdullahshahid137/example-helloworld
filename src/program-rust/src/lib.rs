...
// use crate::instruction_data::Instruction;
...
//     match instruction {
//         Instruction::add => greeting_account.counter += 1 ,
//         Instruction::sub => greeting_account.counter -= 1 ,
//         Instruction::set(i) => greeting_account.counter = i,
//     }
//     greeting_account.serialize(&mut &mut account.data.borrow_mut()[..])?;
